...
In 2012, the MPD overhauled their complaint system for increased accountability and to add internal oversight structures. The Office of Police Conduct Reveiw (OPCR) was established by local ordinance to address complaints and cases of misconduct. Under this system, citizens must submit complaints to OPCR within 270 days of alleged misconduct. After an evidence-gathering period, the OPCR either performs a full investigation within 180 days, refers the complaint to MPD when training is needed over discipline, or dismisses the case @roth2023transforming. There are a number of decision-making steps, each from various participants and with waiting times: the OPCR director’s decision, a panel review, and the police chief’s review and decision. Finally, the case is marked closed, either with Discipline or No Discipline. If the complaint was sustained and resulted in disciplinary action, information such as location and violation type is made public. Otherwise, a case is marked No Discipline and no further details are released. The No Discipline category includes complaints found to be ununstantiated and sustained complaints that resulted in *non-disciplinary* action. For more information about the complaint filing and decision-making process, refer to the OPCR website @opcrprocess. 
